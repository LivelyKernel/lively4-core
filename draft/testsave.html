...
<body>
<h1>Lively 4 -- Bootstrapping Test Page<script data-name="doGreen" type="lively4script">function (that){this.style.color = 'green'}</script><script data-name="goBackToBlack" type="lively4script">function goBackToBlack(that){this.style.color = "black"}</script><script data-name="goGreen" type="lively4script">that =&amp;gt; {this.style.color = 'green'}</script><script data-name="goBlue" type="lively4script">function (that){this.style.color = 'blue'}</script><script data-name="goYellow" type="lively4script">function (that) {this.style.color = 'yellow'}</script></h1>

<p><input type="text" id="baseurl" value="https://github.lively4/repo/numberpi/lively4-core/gh-pages/" /></p>
