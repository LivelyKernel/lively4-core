<script>
  class Pipeline {
    ...
    createView() {
      ...
      for (var i = 0; i < this.sourceCounter; i++) {
        switch((i + 1) % 3) {
          case 0:
      ...
      for (var i = 0; i < this.filtercounter; i++) {
  ...
  class ObjectFabric {
    ...
    buildSquare() {
      return <div id="squares" style="width: 20px; height: 20px; background-color: green; margin: 5px;"></div>
    }
