...
function deprecatedLivelyPatches() {
  ...
  Function.evalJS = lively.lang.fun.evalJS = function(src) { return eval(src); }
  lively.lang.Path.type = lively.PropertyPath;
  lively.lang.Path.prototype.serializeExpr = function () {
    // ignore-in-doc
    return 'lively.PropertyPath(' + Objects.inspect(this.parts()) + ')';
  }

  lively.lang.Closure.type = "lively.Closure";
  lively.lang.fun.methodChain = lively.lang.fun.wrapperChain;

  if (typeof JSON !== "undefined") JSON.prettyPrint = function(jso) { return JSON.stringify(jso, null, 2); };

  Global.NativeArrayFunctions = lively.lang.arrNative;
}
