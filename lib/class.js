...
var classHelper = exports.classHelper = {
  ...
  initializerTemplate: lively.Config && lively.Config.loadRewrittenCode ?
  ...
  newInitializer: function(name) {
    ...
    var src = classHelper.initializerTemplate.replace(/CLASS/g, name);
  ...
  namespaceFor: function(className) {
    ...
    if (lively.module) return lively.module(nsName);
    var path = lively.lang.Path(nsName),
        ns = path.get(Global);
...
exports.class = {
  ...
  addCategorizedMethods: function(klass, categoryName, source) {
    ...
    for (var property in source) {
      ...
      var hasSuperCall = ancestor && typeof value === 'function' &&
          lively.lang.fun.argumentNames(value)[0] == "$super";
      if (hasSuperCall) {
        ...
        (function() {
          ...
          var advice = (function(m) {
            var cs = function callSuper() {
              ...
              if (!method) {
                throw new Error(lively.lang.string.format('Trying to call super of' +
          ...
          value = lively.lang.obj.extend(lively.lang.fun.wrap(advice, method), {
  ...
  superclasses: function(klass) {
    ...
    return lively.lang.class.superclasses(klass.superclass).concat([klass.superclass]);
  },
