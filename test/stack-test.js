...
`;
  ...
  it('getter', () => {
    ...
    expect(stack.getFrame(0).func).to.equal('Object.get myGetter [as myGetter]');
  });
  ...
  it('static getter', () => {
    ...
    expect(stack.getFrame(0).func).to.equal('Function.get myStaticGetter [as myStaticGetter]');
  });
