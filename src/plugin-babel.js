...
async function loadPlugin(name) {
  var mapping = {
    babelPluginJsxLively: "src/client/reactive/reactive-jsx/babel-plugin-jsx-lively-babel7.js",
    ...
    babelPluginActiveExpressionRewriting: 'src/client/reactive/babel-plugin-active-expression-rewriting/index-babel7.js',
    babelPluginDatabindingsPostProcess: 'src/client/reactive/babel-plugin-databindings/post-process.js',
    babelPluginActiveExpressionProxies: 'src/client/reactive/babel-plugin-active-expression-proxies/index-babel7.js',
    ...
    babelPluginVarRecorder: 'src/external/babel-plugin-var-recorder-babel7.js',
