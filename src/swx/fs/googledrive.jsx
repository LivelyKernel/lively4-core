...
export default class Filesystem extends Base {
    ...
    async stat(path) {
        ...
        googledriveHeaders.append('Authorization', 'Bearer ' + this.token) // Bearer 
        let response = await self.fetch('https://api.dropboxapi.com/1/metadata/auto' + this.subfolder + path, {headers: googledriveHeaders})
