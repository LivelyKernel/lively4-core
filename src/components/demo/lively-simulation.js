...
// }" data-view="codeView" data-loginterval="1" data-lively-id="358a6017-4bb6-4d57-b998-4221423bfda2"><i class="fa fa-tint" style="position: relative; font-size: 53px; left: 119px; top: 4px;"></i>
...
//     }
// }" data-view="codeView" data-loginterval="1" data-lively-id="c6eae5ef-cdc4-46df-9258-c0db109f88b8"><i class="fa fa-industry" style="font-size: 58px;position: relative;left: 10px;top: 0px;"></i><i class="fa fa-fire" style="font-size: 37px;position: absolute;left: 101px;top: 232px;"></i></lively-simulation-cell><lively-simulation-cell style="top: 79px; left: 348.709px; z-index: 123; width: 500px; height: 264.28px;" data-name="Heating System" data-state="{&quot;heat&quot;:0,&quot;factor&quot;:20,&quot;max&quot;:5}" data-snippet="var full = max  * factor
// if (heat < full &amp;&amp; #Fuel.gas > max * dt &amp;&amp;
...
// } else {
//     heat -= 0.2 * delta;
// }" data-view="codeView" data-loginterval="1" data-lively-id="80937f3f-2786-45de-8691-c83825696023"><i class="fa fa-industry" style="font-size: 58px; position: relative; left: -2px; top: -2px;"></i>
...
// <i class="fa fa-database" style="font-size: 44px;position: relative;left: 30px;top: 0;"></i></lively-simulation-cell><lively-simulation-cell style="top: 394.26px; left: 863px; z-index: 126; width: 164.533px; height: 100px;" data-name="Battery" data-state="{&quot;energy&quot;:0,&quot;max&quot;:360}" data-snippet="" data-view="codeView" data-loginterval="1" data-lively-id="15c89e50-98bf-4476-91fb-eec24c7173da"><i class="fa fa-battery-full" style="font-size: 46px;position: relative;left: -36px;top: 0;"></i></lively-simulation-cell><lively-simulation-cell style="top: 183px; left: 1191.27px; z-index: 128; width: 468.533px; height: 200px; position: absolute;" data-name="Heat Consumer" data-state="{&quot;consumed&quot;:0,&quot;extra&quot;:0,&quot;demand&quot;:3}" data-snippet="var delta = demand * dt
...
// }
// " data-view="codeView" data-loginterval="1" data-lively-id="8c62075a-2da9-4c8a-b389-2db5668abc39"><i class="fa fa-home" style="font-size: 38px;position: relative;left: 71px;top: -3px;"></i></lively-simulation-cell><lively-simulation-cell style="top: 399.735px; left: 1189px; z-index: 127; width: 447.844px; height: 180px;" data-name="Electric Consumer" data-state="{&quot;consumed&quot;:0,&quot;extra&quot;:0,&quot;demand&quot;:1.5}" data-snippet="demand += (Math.random() - 0.5) * 0.01 * dt
// var delta = demand * dt
...
// }
// " data-view="codeView" data-loginterval="1" data-lively-id="5ee77098-fadb-4e95-9dea-1870e9af548a"><i class="fa fa-plug" style="font-size: 59px;position: relative;left: 163px;top: 0;"></i></lively-simulation-cell>
// `;
