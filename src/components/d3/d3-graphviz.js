...
export default class D3GraphViz extends D3Component {
  ...
  async updateViz() {
    ...
    this.setupGraphviz(this.graph, this.div);
  ...
  async update(data, forceRerender) {
    if (!this.graphviz || forceRerender) {
