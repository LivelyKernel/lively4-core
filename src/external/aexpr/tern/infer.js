...
(function(root, mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    return mod(exports, require("./acorn.js"), require("./acorn_loose.js"), require("./walk.js"),
               require("./def.js"), require("./signal.js"));
  if (typeof define == "function" && define.amd) // AMD
    return define(["exports", "./acorn.js", "./acorn_loose.js", "./walk.js", "./def.js", "./signal.js"], mod);
  ...
  AVal.prototype = extend(ANull, {
    ...
    makeupType: function() {
      ...
      for (var i = 0; i < this.forward.length; ++i) {
        ...
        if (prop && prop != "length" && prop != "<i>" && prop != "â" && prop != cx.completingProperty) {
          props[prop] = true;
          foundProp = prop;
        }
      }
  ...
  function ignoredProp(name) {
    return name == "__proto__" || name == "â" || geckoIterators && name == "__iterator__";
  }
  ...
  exports.findExpressionAt = function(ast, start, end, defaultScope, filter) {
    var test = filter || function(_t, node) {
      if (node.type == "Identifier" && node.name == "â") return false;
