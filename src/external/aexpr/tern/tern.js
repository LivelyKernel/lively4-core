...
(function(root, mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    return mod(exports, require("./infer.js"), require("./signal.js"),
               require("./acorn.js"), require("./walk.js"));
  if (typeof define == "function" && define.amd) // AMD
    return define(["exports", "./infer.js", "./signal.js", "./acorn.js", "./walk.js"], mod);
  ...
  function findCompletions(srv, query, file) {
    ...
    if (prop != null) {
      ...
      if (!completions.length && query.guess !== false && objType && objType.guessProperties)
        objType.guessProperties(function(p, o, d) {if (p != prop && p != "Ã¢ÂÂ" && p != "<i>") gather(p, o, d);});
