/**
 * THIS WORKSPACE IS FOR BENCHMARKING
 */
...
var res = [];
aexpr(() => res[0]).onChange(lively.notify);
res = _.range(0, 10000).map(i => {
  return calculateLoopPath(getRandomNode());
});
"lively";
