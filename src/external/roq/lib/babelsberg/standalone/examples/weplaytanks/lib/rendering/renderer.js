define( function moduleRenderer() {
    var Configuration = Object.subclass("Configuration", {
    ...
    var Renderer = Object.subclass("Renderer", {
        /*
         * Init
         */
        ...
        drawImageOnWorldAABB: function(image, aabb, sourceX, sourceY, width, height, angle) {
            ...
            var halfTargetWidth = targetExtend.x / 2;
            var halfTargetHeight = targetExtend.y / 2;

            this.context.save();

            this.context.translate(targetPosition.x, targetPosition.y);
            this.context.translate(halfTargetWidth, halfTargetHeight);
            ...
            this.context.drawImage(
                ...
                sourceX, sourceY,
                width, height,
                -halfTargetWidth, -halfTargetHeight,
