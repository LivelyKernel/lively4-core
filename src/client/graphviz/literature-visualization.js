...
<browse://src/client/graphviz/keyword-graph.md>

MD*/

/*globals that */

export default class LiteratureFileGraph extends Graph {

  async initialize(parameters = {}) {
    await super.initialize(parameters)

    this.literatureFiles = parameters.literatureFiles
    if (!this.literatureFiles && that.literatureFiles) {
